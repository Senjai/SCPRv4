class ProgramsController < ApplicationController  
  ...
  protected
    ...
    def get_featured_programs
      ...
      @featured_programs.sort_by! { |program| KpccProgram::Featured.index(program.send(:slug)) } # Orders the returned records by the order of the KpccProgram::Featured array
    end
end
