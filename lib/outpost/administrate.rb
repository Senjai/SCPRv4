...
module Outpost
  module Administrate
    ...
    def set_default_columns
      begin
        default_fields = self.column_names - Outpost.config.excluded_list_columns
      ...
      # TODO: Come up with a better solution
        ...
        Rails.logger.warn "Outpost: set_default_columns caught an exception"
        []
      end
    end
    ...
    def set_default_fields
      begin
        self.admin.fields = self.column_names - Outpost.config.excluded_form_fields
      # If the table doesn't exist, just rescue so as not to halt db rake tasks
      # TODO: Come up with a better solution
      rescue
        Rails.logger.warn "Outpost: set_default_fields caught an exception"
        []
      end
    end
  end # Administrate
